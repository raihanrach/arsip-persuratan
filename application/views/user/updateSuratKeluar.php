...
<div class="container-fluid">
    ...
    <form method="POST" action="">
        ...
        <?= form_open_multipart('user/updateSuratKeluar'); ?>
        <form action="" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="tgl" name="tgl" value="<?= $surat_keluar['tgl']; ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="no_agenda" name="no_agenda" value="<?= $surat_keluar['no_agenda']; ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="custom-file">
                        <input type="text" class="form-control" id="lampiran" name="lampiran" value="<?= $surat_keluar['lampiran']; ?>" readonly>
                    </div>
                </div>
            </div>
