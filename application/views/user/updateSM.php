    ...
    <form method="POST" action="">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="tgl" name="tgl" value="<?= $surat_masuk['tgl']; ?>">
                </div>
            </div>

            <div class="form-group row">
                <label for="no_surat" class="col-sm-2 col-form-label">No. Agenda</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="no_agenda" name="no_agenda" value="<?= $surat_masuk['no_agenda']; ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="custom-file">
                        <input type="text" class="form-control" id="lampiran" name="lampiran" value="<?= $surat_masuk['lampiran']; ?>" readonly>
                        <!-- <label class="custom-file-label" for="lampiran"><?= $surat_masuk['lampiran']; ?></label> -->
                    </div>
                </div>
            </div>
            <hr>
